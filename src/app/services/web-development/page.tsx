              ...
              <div className="max-w-7xl mx-auto">
                ...
                <div className="max-w-3xl">
                  <p className="text-base sm:text-lg md:text-xl text-gray-600 leading-relaxed">
                    I build modern, scalable web applications using cutting-edge technologies like React, Next.js, and TypeScript. From responsive frontends to robust backends, I deliver high-performance solutions that scale with your business.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 xl:gap-20">
              ...
              <div className="space-y-8 sm:space-y-10">
                ...
                <div className="space-y-4 text-base sm:text-lg text-gray-600 leading-normal">
                  <p>
                    I start by understanding your business goals and technical requirements. Through{" "}
                    <Highlighter action="highlight" color="#87CEEB" isView={true}>
                      strategic planning
                    </Highlighter>{" "}
                    and architecture design, I create a solid foundation for scalable applications that grow with your needs.
                  </p>
                  <p>
                    Using{" "}
                    ...
                    like React and Next.js, I build{" "}
                    <Highlighter action="highlight" color="#FFE4B5" isView={true}>
                      responsive interfaces
                    </Highlighter>{" "}
                    that deliver exceptional user experiences across all devices. Every component is optimized for performance and maintainability.
                  </p>
                  <p>
                    I ensure{" "}
                    ...
                    throughout the development process. From testing to deployment, I deliver production-ready applications that are secure, fast, and reliable.
                  </p>
                </div>
...
const previousWorkItems = [
  ...
  },
  {
    ...
    description: "Creative portfolio site with smooth animations and responsive design.",
    image: "/web-ui/3.webp",
  },
  {
    name: "Blog Platform",
    description: "Content management system with SEO optimization and fast loading times.",
    image: "/web-ui/4.webp",
  },
  {
    name: "Corporate Website",
    description: "Professional business website with modern design and integrated contact forms.",
    image: "/apps-ui/1.jpg",
  },
  {
    name: "Landing Page",
    description: "High-converting landing page with A/B testing and analytics integration.",
    image: "/apps-ui/2.jpg",
  },
];
...
function SubServicesSection() {
  const subServices = [
    ...
    },
    {
      ...
      description: "Creating robust APIs, server-side logic, and database architectures for scalable applications.",
    },
    {
      title: "Full-Stack Solutions",
      description: "End-to-end development from frontend to backend, ensuring seamless integration and optimal performance.",
    },
    {
      title: "Performance Optimization",
      description: "Optimizing loading times, code splitting, and implementing caching strategies for faster applications.",
    },
    {
      title: "API Integration",
      description: "Integrating third-party APIs, payment gateways, and external services to extend functionality.",
    },
    {
      title: "Deployment & DevOps",
      description: "Setting up CI/CD pipelines, cloud deployment, and monitoring for reliable production environments.",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-12 sm:mb-16 md:mb-20">
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-600 leading-relaxed max-w-3xl">
              Comprehensive web development services covering frontend, backend, and full-stack solutions using modern technologies.
            </p>
          </div>
