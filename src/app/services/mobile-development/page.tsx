              ...
              <div className="max-w-7xl mx-auto">
                ...
                <div className="max-w-3xl">
                  <p className="text-base sm:text-lg md:text-xl text-gray-600 leading-relaxed">
                    I develop native and cross-platform mobile applications for iOS and Android. Using React Native and modern mobile technologies, I create apps that deliver exceptional user experiences with smooth performance.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-8 sm:space-y-10">
                ...
                <div className="space-y-4 text-base sm:text-lg text-gray-600 leading-normal">
                  <p>
                    ...
                    principles, ensuring your app works seamlessly across all devices. Through{" "}
                    <Highlighter action="highlight" color="#87CEEB" isView={true}>
                      user testing
                    </Highlighter>{" "}
                    and iterative development, I create intuitive interfaces that users love.
                  </p>
                  <p>
                    Using{" "}
                    ...
                    and native technologies, I build{" "}
                    <Highlighter action="highlight" color="#DDA0DD" isView={true}>
                      cross-platform apps
                    </Highlighter>{" "}
                    that maintain native performance while reducing development time and costs.
                  </p>
                  <p>
                    I ensure{" "}
                    ...
                    across iOS and Android. From app store submission to post-launch updates, I handle every aspect of mobile development.
                  </p>
                </div>
...
const previousWorkItems = [
  {
    ...
    description: "Native iOS and Android app with real-time workout tracking and progress analytics.",
    image: "/apps-ui/1.jpg",
  },
  {
    name: "Social Media App",
    description: "Cross-platform social app with real-time messaging and media sharing features.",
    image: "/apps-ui/2.jpg",
  },
  {
    name: "E-commerce Mobile",
    description: "Shopping app with secure payments, wishlist, and personalized recommendations.",
    image: "/apps-ui/3.jpg",
  },
  {
    name: "Food Delivery App",
    description: "On-demand delivery app with GPS tracking and real-time order updates.",
    image: "/web-ui/1.webp",
  },
  {
    name: "Banking Mobile App",
    description: "Secure banking app with biometric authentication and transaction management.",
    image: "/web-ui/2.webp",
  },
  {
          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 sm:gap-6">
            <div className="space-y-3 sm:space-y-4 flex-1">
              ...
              <p className="text-muted-foreground max-w-md text-sm sm:text-base leading-snug">
                Explore my collection of mobile applications built for iOS and Android platforms.
              </p>
            </div>
  ...
  const subServices = [
    {
      ...
      description: "Native iOS app development using Swift and SwiftUI for optimal performance and Apple ecosystem integration.",
    },
    {
      title: "Android Development",
      description: "Native Android apps built with Kotlin and Jetpack Compose for modern, responsive interfaces.",
    },
    {
      title: "React Native",
      description: "Cross-platform mobile development enabling code sharing between iOS and Android platforms.",
    },
    {
      title: "App Store Optimization",
      description: "Optimizing app listings, screenshots, and metadata to maximize visibility and downloads.",
    },
    {
      title: "Push Notifications",
      description: "Implementing real-time notifications to engage users and drive app retention.",
    },
    {
      title: "Mobile UI/UX",
      description: "Designing intuitive mobile interfaces that follow platform guidelines and best practices.",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-12 sm:mb-16 md:mb-20">
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-600 leading-relaxed max-w-3xl">
              Comprehensive mobile development services for iOS, Android, and cross-platform solutions.
            </p>
          </div>
